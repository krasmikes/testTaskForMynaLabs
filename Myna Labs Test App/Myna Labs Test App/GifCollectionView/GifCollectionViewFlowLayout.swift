...
//
// taken from https://www.raywenderlich.com/4829472-uicollectionview-custom-layout-tutorial-pinterest
...
class GifCollectionViewFlowLayout: UICollectionViewFlowLayout {
    ...
    override func prepare() {
        ...
        for item in 0..<collectionView.numberOfItems(inSection: 0) {
            ...
            if let photoSize = delegate?.collectionView(collectionView, photoSizeAtIndexPath: indexPath) {
                photoHeight = photoSize.height / photoSize.width * columnWidth
            } 
